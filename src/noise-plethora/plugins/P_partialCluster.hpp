...
public:
	...
	void process(float k1, float k2) override {
		...
		waveform4_1.frequency(simd::float_4(fundamental, f2 * fundamental, f3 * fundamental, f4 * fundamental));
		waveform4_2.frequency(simd::float_4(f5 * fundamental, f6 * fundamental, f7 * fundamental, f8 * fundamental));
		waveform4_3.frequency(simd::float_4(f9 * fundamental, f10 * fundamental, f11 * fundamental, f12 * fundamental));
		waveform4_4.frequency(simd::float_4(f13 * fundamental, f14 * fundamental, f15 * fundamental, f16 * fundamental));
	}
